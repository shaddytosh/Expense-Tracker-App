...
import com.shashank.expense.transactionDb.AppDatabase;
import com.shashank.expense.transactionDb.AppExecutors;
import com.shashank.expense.transactionDb.TransactionEntry;
import com.shashank.expense.transactionDb.TransactionViewModel;
import com.shashank.expense.utils.Constants;
...
public class AddExpenseActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intentFrom.equals(Constants.addIncomeString)) {
            ...
            categories.add("Meal");
            categories.add("Cloud Service");
            categories.add("Miscellaneous Expenditure");
